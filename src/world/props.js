...
// Snow settles on whatever faces the sky. Used by the stones and the timber.
...
export function createProps(scene) {
	...
	// A ring of boulders holding the drift back from the clearing.
