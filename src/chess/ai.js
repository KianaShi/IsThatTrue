// Negamax with alpha-beta, quiescence and a tapered piece-square evaluation.
...
// Read top-left as a8. Values are centipawns / 2 to keep the tables terse.
const PST_MG = {
	[PAWN]: t([
		0, 0, 0, 0, 0, 0, 0, 0,
...
export function search(pos, { level = 'club', nodeBudget = 4e6 } = {}) {
	...
	// Weaker levels occasionally settle for a near-best move, so repeat games
	// diverge and a human gets something to punish.
