...
// Cold grade + breathing vignette + a dusting of grain, applied after tone mapping.
const GradeShader = {
	uniforms: {
		tDiffuse: { value: null },
		uTime: { value: 0 },
	...
	fragmentShader: /* glsl */`
		...
		void main(){
			...
			// A whisper of lateral dispersion at the frame edge.
			...
			// Cold shadows, faintly warm highlights.
